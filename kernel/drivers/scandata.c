...
static const char *const keycode_names[KEY_MAX] = {
	...
	[KEY_ENTER] = "KEY_ENTER", [KEY_TAB] = "KEY_TAB", [KEY_SPACE] = "KEY_SPACE",
	...
	[KEY_KPPLUS] = "KEY_KPPLUS", [KEY_KPMINUS] = "KEY_KPMINUS", [KEY_KPSTAR] = "KEY_KPSTAR",
	[KEY_KPSLASH] = "KEY_KPSLASH", [KEY_KPDOT] = "KEY_KPDOT", [KEY_KPENTER] = "KEY_KPENTER",

	[KEY_PRINTSCREEN] = "KEY_PRINTSCREEN", [KEY_PAUSE] = "KEY_PAUSE",
};
